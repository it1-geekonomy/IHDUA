...
function FooterHeading({ children }: { children: React.ReactNode }) {
  return <h3 className="text-lg font-bold text-[#FFD638]">{children}</h3>;
}
      ...
      <div className={`${CONTAINER} lg:py-8`}>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-[minmax(320px,1fr)_auto] gap-x-6 md:gap-x-8 gap-y-10 lg:gap-y-0 lg:gap-x-12 lg:items-start">
          <div className="col-span-2 md:col-span-3 lg:col-span-1 space-y-2 lg:max-w-md lg:shrink-0">
            <Logo />
            <p className="text-white text-center lg:text-left mx-auto lg:mx-0 text-lg">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1 grid grid-cols-2 md:grid-cols-3 gap-x-6 md:gap-x-8 gap-y-10 lg:flex lg:flex-row lg:items-start lg:gap-x-16 xl:gap-x-20 2xl:gap-x-24">
            <div className="col-span-1">
              ...
              <ul className="mt-8 space-y-3 text-nowrap">
                {FOOTER_WHAT_WE_DO.map((label) => (
                  <li key={label}>
                    <Link href="/" className="text-white hover:text-[#FFD638] transition-colors text-lg">
                      {label}
                    </Link>
                  </li>
                ))}
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="mt-8 space-y-3">
                <p className="text-white text-lg max-w-[260px]">{FOOTER_HEADQUARTERS.address}</p>
                <a href={FOOTER_HEADQUARTERS.emailLink}
  translate="no"
  className="notranslate block text-white hover:text-[#FFD638] transition-colors text-lg"
>
  {FOOTER_HEADQUARTERS.email}
</a>
                <a href={FOOTER_HEADQUARTERS.phoneLink} className="block text-white hover:text-[#FFD638] transition-colors text-lg">
      ...
      <div className="bg-[#FFD638] py-2">
        <div className={CONTAINER}>
          <div className="flex flex-col lg:flex-row justify-between items-center gap-1 lg:gap-0">
            <p className="text-[#00191B] text-sm">© {new Date().getFullYear()} IHDUA. All rights reserved.</p>

            <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-4">
              <Link href="/" className="text-[#00191B] text-sm hover:underline">
                Privacy Policy
              </Link>
              <Link href="/" className="text-[#00191B] text-sm hover:underline">
                Terms of Service
              ...
              <div
                className={`flex items-center gap-1 rounded-full bg-black px-1 py-1 text-sm transition-opacity ${
