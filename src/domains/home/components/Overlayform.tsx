...
//   const pillBase = "rounded-md px-4 py-3 text-sm font-semibold border transition-colors";
...
//           {/* Right content */}
//           <div className="flex w-full flex-col justify-start overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden px-6 sm:px-8 lg:h-full lg:w-[55%] lg:px-12 bg-[#F6F2EC] pt-8 lg:pt-12 xl:pt-20">
//             <h2 id="overlayform-title" className="text-[26px] font-semibold leading-tight text-[#00191B] lg:text-[40px] pb-4 lg:pb-8 lg:max-w-xl">
//               Strengthening Rural Lives, Building Better Futures
//             </h2>
//             <p className="text-lg text-gray-600 pb-10 xl:pb-14 lg:max-w-lg">
...
//             {/* Amount selection */}
//             <p className="pb-3 pt-4 xl:pt-6 2xl:pt-12 text-xl font-normal text-[#6B6660]">Choose an amount</p>
...
//                     placeholder="0"
//                     className="ml-1 w-16 bg-transparent text-sm font-semibold text-white placeholder:text-white/70 outline-none"
//                   />
//                 </span>
//               ) : (
//                 <button
...
//             <button
//               type="button"
//               className="mb-3 flex w-full items-center justify-center gap-2 rounded-md bg-[#FDC61D] px-6 py-3.5 text-base font-bold text-[#00191B] transition-transform hover:scale-[1.01] active:scale-[0.99]"
//             >
//               Donate Now
...
//             {/* Secure note */}
//             <div className="flex items-center justify-center gap-1.5 text-xs text-[#B0A99F]">
